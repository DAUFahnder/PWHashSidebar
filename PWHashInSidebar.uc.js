 ...
 ************************************************************/
 ...
 var PWHashInSidebar_BreiteStart = "210";  // Breite in Pixel (px) mit dem die Sidebar startet. Kann anschliessend per Maus jederzeit angepasst werden. 
...
<style>body {font-size: 17px; padding: 1px; margin: 5px;} input%23nummer {width: 5ex;text-align:center;-moz-appearance: textfield;margin-top: 4px;} div%23genfeld {text-align: center;} div%23hilfe {font-size: 87%;-moz-hyphens: auto;-o-hyphens: auto;-webkit-hyphens: auto;-ms-hyphens: auto;hyphens: auto;}</style>\
		...
		CustomizableUI.createWidget({
			...
			onBuild: function(aDocument) {			
				...
				var props = {
					...
					style: 'list-style-image: url(\'data:image/png;base64,\')',
