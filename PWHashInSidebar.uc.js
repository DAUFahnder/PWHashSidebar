 ...
 */
 ...
 /********** Im Netz gefunden und entsprechend angepasst von:
 /**********
 /********** DAUFahnder / daufahnder@maikkoenig.de
 /**********
 /********** Die Sammlung kann ganz nach Wunsch verändert und
 /********** woanders eingesetzt werden, aber ich würde mich
 /********** über eine eMail freuen!
 ...
 ************************************************************/
  ...
  var PWHashInSidebar_BreiteStart = "180";                      // Breite in Pixel mit dem die Sidebar startet. Kann anschliessend per Maus jederzeit angepasst werden. 
  ...
  // Design-Vorgaben um die Sidebar dem eigenen Geschmack anzupassen:
   
  var PWHashInSidebar_Splitter_Style_Breite = "2";              // Welche Breite in Pixel soll der Splitter (damit kann man die Sidebar per Maus breiter ziehen) haben?
  var PWHashInSidebar_Splitter_Style_Farbe = "grey";            // Welche Farbe soll der Splitter haben? Alle CSS-Farbcodes sind möglich. 
  var PWHashInSidebar_LadenDefaultFontSize = "17";              // Welche Bezugsschriftgrösse in Pixel soll von der Standardseite (PWHash) benutzt werden? Alle CSS-Codes für Farbe sind möglich
  var PWHashInSidebar_LadenDefaultFarbeHintergrund = "grey";    // Welche Hintergrundfarbe soll von der Standardseite (PWHash) benutzt werden? Alle CSS-Codes für Farbe sind möglich
  var PWHashInSidebar_LadenDefaultFarbeText = "black";          // Welche Textfarbe soll von der Standardseite (PWHash) benutzt werden? Alle CSS-Codes für Farbe sind möglich
  var PWHashInSidebar_LadenDefaultMargin = "4";                 // Welchen Abstand in Pixel soll die Standardseite (PWHash) von den Rändern halten ("margin" für body)?    
  
  /**************************************************
   * nachfolgend die PWHash-Seite als HTML-Datenstrom
   * nur ändern wenn man weiss was man macht!
   * Die PWHash-Seite wird geliefert wie sie ist, ohne
   * Garantie für Fehlerfreiheit oder irgendwelche 
   * Sicherheitsversprechen!
   * Ersteller: DAUFahnder / daufahnder@maikkoenig.de
   *************************************************/
...
var windowListener = {
	...
	loadIntoWindow: function (aDOMWindow, aXULWindow) {
        ...
        style: "width: "+PWHashInSidebar_Splitter_Style_Breite+"px; background-color: "+PWHashInSidebar_Splitter_Style_Farbe+";",       
