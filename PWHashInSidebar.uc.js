 ...
 ************************************************************/
  ...
  var PWHashInSidebar_LadenDefault = "ja";  // Soll die Standardseite dieser Datei geladen werden? 
...
<style>body {font-size: 17px; padding: 1px; margin: 4px; text-align: justify; background:grey;} input%23nummer {width: 5ex;text-align:center;-moz-appearance: textfield;margin-top: 4px;} div%23genfeld {text-align: center;} div%23hilfe {font-size: 87%;-moz-hyphens: auto;-o-hyphens: auto;-webkit-hyphens: auto;-ms-hyphens: auto;hyphens: auto;}</style>\
